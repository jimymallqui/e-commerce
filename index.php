...
<html lang="es">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/diamante.ico">
	...
	<div class="product">		
		<div class="product-image" >
			<div class="image">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="100" height="200" alt="MDN"></a>
			</div><!-- /.image     width="100" height="200" alt="MDN"   -->			
